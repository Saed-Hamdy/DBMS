...
public class Parser implements IParser {
    ...
    {
    	return Dpms.getWantedData();
    }
    
    public ArrayList<String> getColumnNames()
    {
    	return Dpms.getCoulmnNames();
    }
    
    public String getTableName()
    {
    	return Dpms.getTableName();
    }
    ...
    public static void main(String[] args) {
        ...
        // if there is not semicolon it will work and this is wrong
        
        a.InsertQuery("CREATE DATABASE my_db;");
        
        /*
        a.InsertQuery("create table students(id int,Name varchar,Age int);");//not ok as matches if statement fail
        
        a.InsertQuery("INSERT INTO students VALUES (1,'saeed',32);");// don't transfer the value.
        a.InsertQuery("INSERT INTO students VALUES (2,'hossam',330000098687656546);");
        a.InsertQuery("INSERT INTO students VALUES (3,'amr',33);");
        a.InsertQuery("INSERT INTO students VALUES (4,'arsanuos',4);");
        
        a.InsertQuery("INSERT INTO students (id,name) students VALUES (9,'arsanuos essa');");//not match.
        a.InsertQuery("UPDATE students SET id=18,name='tedata' , WHERE age=32;"); // not match
        a.InsertQuery("UPDATE students SET id=18,name='tedata',age=22234, WHERE age=32;"); // not match
        
        a.InsertQuery("DELETE FROM students WHERE name='arsanuos';"); // not match as value transfered with ''
        
        ArrayList<ArrayList<String>> x = a.getData();
        p.printTable(a.getColumnNames(), a.getData(), a.getTableName());
        */
    }
